...
def Event11605397():
    ...
    IfFlagOn(-1, 13)
    IfConditionTrue(0, input_condition=-1)
    DisableMapCollision(Collisions.h9000B0_0000)
    DisableMapCollision(Collisions.h9000B0_0001)
    EndIfFlagOn(13)
    IfCharacterDoesNotHaveSpecialEffect(0, PLAYER, 2200)
    EnableMapCollision(Collisions.h9000B0_0000)
    EnableMapCollision(Collisions.h9000B0_0001)
    Restart()
...
def Event11600150():
    ...
    DisableMapCollision(Collisions.h0000B0_0002)
    DisableMapCollision(Collisions.h0001B0_0001)
    DisableMapCollision(Collisions.h0002B0_0001)
    DisableMapCollision(Collisions.h0003B0_0001)
    DisableMapCollision(Collisions.h0004B0_0001)
    DisableMapCollision(Collisions.h0005B0_0001)
    DisableMapCollision(Collisions.h0106B0_0000)
    DisableMapCollision(Collisions.h0010B0_0001)
    DisableMapCollision(Collisions.h0011B0_0001)
    DisableMapCollision(Collisions.h0012B0_0001)
    DisableMapCollision(Collisions.h0020B0_0001)
    DisableMapCollision(Collisions.h0021B0_0001)
    DisableMapCollision(Collisions.h0022B0_0001)
    DisableMapCollision(Collisions.h0023B0_0001)
    DisableMapCollision(Collisions.h0024B0_0001)
    DisableMapCollision(Collisions.h0025B0_0001)
    DisableMapCollision(Collisions.h0026B0_0001)
    DisableMapCollision(Collisions.h0027B0_0001)
    ...
    DisableMapCollision(Collisions.h0130B0_0000)
    DisableMapCollision(Collisions.h0154B0_0000)
    IfFlagOn(0, 11600100)
    EnableMapCollision(Collisions.h0000B0_0002)
    EnableMapCollision(Collisions.h0001B0_0001)
    EnableMapCollision(Collisions.h0002B0_0001)
    EnableMapCollision(Collisions.h0003B0_0001)
    EnableMapCollision(Collisions.h0004B0_0001)
    EnableMapCollision(Collisions.h0005B0_0001)
    EnableMapCollision(Collisions.h0106B0_0000)
    EnableMapCollision(Collisions.h0010B0_0001)
    EnableMapCollision(Collisions.h0011B0_0001)
    EnableMapCollision(Collisions.h0012B0_0001)
    EnableMapCollision(Collisions.h0020B0_0001)
    EnableMapCollision(Collisions.h0021B0_0001)
    EnableMapCollision(Collisions.h0022B0_0001)
    EnableMapCollision(Collisions.h0023B0_0001)
    EnableMapCollision(Collisions.h0024B0_0001)
    EnableMapCollision(Collisions.h0025B0_0001)
    EnableMapCollision(Collisions.h0026B0_0001)
    EnableMapCollision(Collisions.h0027B0_0001)
    ...
    EnableMapCollision(Collisions.h0130B0_0000)
    EnableMapCollision(Collisions.h0154B0_0000)
    DisableSoundEvent(1603850)
    DisableMapCollision(Collisions.h0000B0_0000)
    DisableMapCollision(Collisions.h0001B0_0000)
    DisableMapCollision(Collisions.h0002B0_0000)
    DisableMapCollision(Collisions.h0003B0_0000)
    DisableMapCollision(Collisions.h0004B0_0000)
    DisableMapCollision(Collisions.h0005B0_0000)
    DisableMapCollision(Collisions.h0006B0_0000)
    DisableMapCollision(Collisions.h0010B0_0000)
    DisableMapCollision(Collisions.h0011B0_0000)
    DisableMapCollision(Collisions.h0012B0_0000)
    DisableMapCollision(Collisions.h0020B0_0000)
    DisableMapCollision(Collisions.h0021B0_0000)
    DisableMapCollision(Collisions.h0022B0_0000)
    DisableMapCollision(Collisions.h0023B0_0000)
    DisableMapCollision(Collisions.h0024B0_0000)
    DisableMapCollision(Collisions.h0025B0_0000)
    DisableMapCollision(Collisions.h0026B0_0000)
    DisableMapCollision(Collisions.h0027B0_0000)
...
def Event11600100():
    ...
    DisableMapCollision(Collisions.h7000B0_0000)
    DisableMapCollision(Collisions.h7000B0_0001)
    DisableMapCollision(Collisions.h8000B0_0000)
    DisableMapCollision(Collisions.h8000B0_0001)
    DisableObject(Objects.o6500_0000)
    DisableFlag(404)
    End()
    EnableMapCollision(Collisions.h8000B0_0000)
    EnableMapCollision(Collisions.h8000B0_0001)
    IfFlagOn(0, 11600101)
    SkipLinesIfMultiplayer(2)
